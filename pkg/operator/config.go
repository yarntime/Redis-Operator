...
func (c *Config) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&c.Master, "master", "192.168.254.44:8080", "The address of the Kubernetes API server. Overrides any value in kubeconfig. Only required if out-of-cluster.")
